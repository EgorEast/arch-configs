...
alias upgrade_yazi_packages='ya pkg upgrade ndtoan96/ouch dedukun/relative-motions lpanebr/yazi-plugins:first-non-directory h-hg/yamb yazi-rs/plugins:chmod Lil-Dank/lazygit boydaihungst/restore yazi-rs/plugins:git yazi-rs/plugins:full-border yazi-rs/plugins:piper BennyOe/tokyo-night'
